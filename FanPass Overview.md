...
- Role-first homepage with a concise hero, no default waitlist shortcut, refined audience card copy for each role, aligned card text/buttons, bold role buttons, and progressive disclosure
