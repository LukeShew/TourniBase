...
- Parent phone mockup uses a visibly larger scaled TourniBase logo lockup aligned to the left edge of the pass card, tuned status-bar positioning with a larger time, iOS-style cell/battery indicators, and a smaller standard bell notification icon
