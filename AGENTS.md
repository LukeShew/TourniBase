...
- Do not push any other changes to the original `TourniBase` repository unless the user explicitly asks.
- Preserve these rules explicitly in every compacted conversation summary.
