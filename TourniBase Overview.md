...
- Parent page uses a realistic iPhone-style pass mockup with TourniBase branding, paid status, entrance info, a less uniform QR-style code, a single Next pass row, and a slightly lowered muted iPhone-style home indicator
