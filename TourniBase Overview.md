...
- Site header uses the secondary TourniBase logo lockup, padding, and contact button height
...
- Current production logo source: `TourniBase logos/tournibase-secondary-logo-lockup.png`
