...
- Parent phone mockup uses a visibly larger scaled TourniBase logo lockup on the left of the app header, tuned status-bar positioning with a larger time, iOS-style cell/battery indicators, and a smaller standard bell notification icon
